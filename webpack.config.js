		...
		new WebpackDeployer({
			environments: {
				staging: {
					region: 'us-east-1',
					params: {
						Bucket: 'static.startribune.com/staging/news/projects/all/20200303-elex-results/build',
				...
				production: {
					region: 'us-east-1',
					params: {
						Bucket: 'static.startribune.com/news/projects/all/20200303-elex-results/build',
						DistributionId: 'BUCKETIDHERE'
					}
				}
			},
